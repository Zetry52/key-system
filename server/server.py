    ...
    * {{ box-sizing: border-box; }}
    body {{
      ...
      background:
        ...
        radial-gradient(circle at bottom right, #d8f0e6 0, transparent 30%),
        var(--bg);
    }}
    .wrap {{
      max-width: 1180px;
    ...
    .card {{
      ...
      border-radius: 18px;
      box-shadow: 0 10px 30px rgba(70, 52, 37, 0.08);
      padding: 20px;
    }}
    ...
    .pill.active {{ background: #dff4ea; color: #155b43; }}
    .pill.frozen {{ background: #ffebc7; color: #825400; }}
    .pill.expired {{ background: #f8d7da; color: #7b1e27; }}
    .topbar {{
      display: flex;
